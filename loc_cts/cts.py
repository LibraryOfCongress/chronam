...
class CTS(object):
    ...
    def _request(self, url, method="get", params={}, data=None):
        ...
        r = requests.request(
            method, url, params=params, data=data, headers=headers, auth=self.auth, verify=self.verify_ssl
        )
        ...
        if r.status_code == 200:
            ...
            logger.error("%s %s with %s resulted in %s", method, url, params, r.status_code)
            return None
