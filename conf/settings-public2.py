...
DATABASE_HOST = '/tmp/mysql_public2.sock'             # Set to empty string for localhost. Not used with sqlite3.
DATABASE_PORT = '3301'             # Set to empty string for default. Not used with sqlite3.
DATABASE_OPTIONS = { 'unix_socket': '/tmp/mysql_public2.sock' }
