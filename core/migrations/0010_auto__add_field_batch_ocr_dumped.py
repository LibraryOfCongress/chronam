...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Batch.ocr_dumped'
        db.add_column('core_batch', 'ocr_dumped',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Batch.ocr_dumped'
        db.delete_column('core_batch', 'ocr_dumped')
    ...
    models = {
        ...
        'core.batch': {
            ...
            'ocr_dumped': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
