...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Essay.filename'
        db.delete_column('core_essay', 'filename')

        # Adding field 'Essay.modified'
        db.add_column('core_essay', 'modified', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Essay.essay_editor_url'
        db.add_column('core_essay', 'essay_editor_url', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Essay.filename'
        raise RuntimeError("Cannot reverse this migration. 'Essay.filename' and its values cannot be restored.")

        # Deleting field 'Essay.modified'
        db.delete_column('core_essay', 'modified')

        # Deleting field 'Essay.essay_editor_url'
        db.delete_column('core_essay', 'essay_editor_url')
    ...
    models = {
        ...
        'core.essay': {
            ...
            'essay_editor_url': ('django.db.models.fields.TextField', [], {'null': 'True'}),
