...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Title.has_issues'
        db.add_column('core_title', 'has_issues', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Title.has_issues'
        db.delete_column('core_title', 'has_issues')
