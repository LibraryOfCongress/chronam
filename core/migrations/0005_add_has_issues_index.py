...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Title', fields ['has_issues']
        db.create_index('core_title', ['has_issues'])


    def backwards(self, orm):
        
        # Removing index on 'Title', fields ['has_issues']
        db.delete_index('core_title', ['has_issues'])
