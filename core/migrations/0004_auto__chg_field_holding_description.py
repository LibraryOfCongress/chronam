...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Holding.description'
        db.alter_column('core_holding', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Holding.description'
        db.alter_column('core_holding', 'description', self.gf('django.db.models.fields.TextField')(default=''))
