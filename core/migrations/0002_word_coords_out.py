...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OCR.word_coordinates_json'
        db.delete_column('core_ocr', 'word_coordinates_json')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OCR.word_coordinates_json'
        raise RuntimeError("Cannot reverse this migration. 'OCR.word_coordinates_json' and its values cannot be restored.")
