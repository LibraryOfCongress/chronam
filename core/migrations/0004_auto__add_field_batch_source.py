...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Batch.source'
        db.add_column('core_batch', 'source', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Batch.source'
        db.delete_column('core_batch', 'source')
