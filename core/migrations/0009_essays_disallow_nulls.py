...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Essay.modified'
        db.alter_column('core_essay', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 28, 23, 37, 46, 995430)))

        # Changing field 'Essay.essay_editor_url'
        db.alter_column('core_essay', 'essay_editor_url', self.gf('django.db.models.fields.TextField')(default='http://example.com'))


    def backwards(self, orm):
        
        # Changing field 'Essay.modified'
        db.alter_column('core_essay', 'modified', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Essay.essay_editor_url'
        db.alter_column('core_essay', 'essay_editor_url', self.gf('django.db.models.fields.TextField')(null=True))
