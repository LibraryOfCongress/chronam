...
/*** REMOVE THIS LINE AND 80** PORTS FOR PROD ***/
var cur_url=''+window.location.href;
if(cur_url.indexOf('loc.gov:8081/staff')>-1||cur_url.indexOf('loc.gov:8081/extranet')>-1||cur_url.indexOf('col=staff')>-1) s_account="locintranetdev";

if(!s_account) var s_account="locgovdev"
...
function s_doPlugins(s) {
	...
	/** JS FILE VERSION **/
	s.prop9=s.eVar19="DEV31AUG2009V1JNP";
	...
	if(s.prop2) {
		...
		if(s.currentURL) {
			...
			/** REMOVEFORPROD - - TRACK SEARCH FOR DEV SITES **/
			/* production line works for - fedsearch */
			else if(s.currentURL.indexOf('sun20.loc.gov:8766/query.html')>-1) s.prop3="ultraseek";
			else if(s.currentURL.indexOf('sun11.loc.gov:8080/search')>-1) s.prop3="ndnp";
			else if(s.currentURL.indexOf('ilstest1.loc.gov')>-1) s.prop3="catalog";
			else if(s.currentURL.indexOf('ho.rdc.lctl.gov')>-1) s.prop3="wdl";
			else if(s.currentURL.indexOf('lcweb2.loc.gov:8081/diglib/lcwa')>-1) s.prop3="webarch";
			/* production line works for - digguide */
			else if(s.currentURL.indexOf('digitizationguidelines.gov:8081/term.php')>-1) s.prop3="diggterm";
			/* production line works for - digpres */
			else if(s.currentURL.indexOf('lcweb2.loc.gov:8081/diglib/sclc')>-1) s.prop3="speccoll";
